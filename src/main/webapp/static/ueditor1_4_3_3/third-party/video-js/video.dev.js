...
vjs.options = {
  ...
  // Default of blog browser is 300x150. Should rely on source width/height.
  'width': 300,
  'height': 150,
  // defaultVolume: 0.85,
 ...
 * @param  {Number} guide   Number (in seconds) to entity the string after
...
vjs.Flash = vjs.MediaTechController.extend({
  ...
  init: function(player, options, ready){
    ...
    // Flash iFrame Mode
    // In blog browsers there are multiple instances where changing the parent element or visibility of a plugin causes the plugin to reload.
    ...
    // Even though the iframe was inserted into a page on the blog, Firefox + Flash considers it a local app trying to access an internet file.
